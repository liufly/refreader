...
# class FairseqLanguageModelSpan(FairseqLanguageModel):
#     def __init__(self, decoder):
#         super().__init__(decoder)
    
#     def forward(self, src_tokens, src_ner=None, src_chunk=None):
#         return self.decoder(src_tokens, src_ner, src_chunk)
