...
def add_distributed_training_args(parser):
    ...
    group.add_argument('--distributed-world-size', type=int, metavar='N',
                       default=1, #default=torch.cuda.device_count(),
...
def add_optimization_args(parser):
    ...
    group.add_argument('--clip-norm', default=0.1, type=float, metavar='NORM',
    ...
    group.add_argument('--weight-decay', '--wd', default=5e-6, type=float, metavar='WD',
                       help='weight decay')

    # Learning rate schedulers can be found under fairseq/optim/lr_scheduler/
    group.add_argument('--lr-scheduler', default='reduce_lr_on_plateau_patience',
                       help='learning rate scheduler: {} (default: reduce_lr_on_plateau_patience)'.format(
                           ', '.join(LR_SCHEDULER_REGISTRY.keys())))
    group.add_argument('--lr-shrink', default=0.5, type=float, metavar='LS',
...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--restore-dir', metavar='DIR', default='checkpoints',
    ...
    group.add_argument('--no-train', action='store_true', default=False,
                       help='only validate on the test set')
    return group
