...
class LanguageModelingTask(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--sample-break-mode', metavar='VAL',
                            choices=['none', 'complete', 'eos', 'cbt_booktitle'],
    ...
    def load_dataset(self, split, combine=False):
        ...
        for k in itertools.count():
            ...
            if self.args.sample_break_mode == 'cbt_booktitle':
                if self.dictionary.index('_BOOK_TITLE_') != self.dictionary.unk():
            ...
            loaded_datasets.append(
                TokenBlockDataset(
                    ...
                    include_targets=True, cbt_booktitle_idx=cbt_booktitle_idx,
                ))
